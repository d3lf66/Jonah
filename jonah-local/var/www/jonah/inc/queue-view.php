...
<tr id="header" class='tabhead-transcode nodrop nodrag'><td>&nbsp; <!-- drag icon --></td><td> Queue </td><td> Cat </td><td> Client </td><td> File </td><td> Size </td><td> Duration </td><td> Uploaded </td><td>&nbsp;</td><td> Source </td><td> Video </td><td> Audio </td><td> Status </td><td> State </td><td>&nbsp; <!-- encode state icon --></td></tr>

<!-- sample row -->

<tr id="row0" class='#transcoding nodrop nodrag'><td>&nbsp;</td><td> 0</td><td>TVP</td><td> PLAYBOY </td><td>playboy-catfight_dallas.mpg</td><td>300 Mb</td><td>01:20:00</td><td>July 23, 12:01</td><td>HD</td><td>1280x720</td><td>h264, 480x288, 997 kb/s, 24.99 fps</td><td>aac, 48 Khz, mono, s16, 63 kb/s</td><td>transcoding - 85%<br /><img src='/jonah/images/upload.png' /></td><td> 8 </td><td><img src='/jonah/images/transcode-live.png' /></td></tr>

<?

	$explodeID="*";
	$progressBar=0;																// 	used to separate json-encoded arrays
...
?>
<tr id="<? echo $queue['queue-id']; ?>"><td>&nbsp;</td><td><? echo $queue['queue-id']; ?></td><td><? echo $queue['category']; ?></td><td><? echo $queue['client']; ?></td><td><? echo $queue['filename']; ?></td><td><? echo $queue['filesize']; ?> Mb</td><td><? echo $queue['duration']; ?></td><td><? echo $queue['timestamp']; ?></td><td><? echo($sdorhd); ?></td><td><? echo ($resolution); ?></td><td><? echo ($queue['video']); ?></td><td><? echo ($queue['audio']); ?></td><td>
<? 
